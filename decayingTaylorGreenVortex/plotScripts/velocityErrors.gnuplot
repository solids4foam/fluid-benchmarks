...
plot \
    "hex.lu.summary.txt" u (1e3*$1):($4) w lp pt 5 lc "green" t "L_1", \
    "hex.lu.summary.txt" u (1e3*$1):($5) w lp pt 15 lc "red" t "L_2", \
    "hex.lu.summary.txt" u (1e3*$1):($6) w lp pt 9 lc "blue" t "L_∞", \
